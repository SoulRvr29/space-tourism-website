  ...
  return (
    <div className="flex flex-col justify-evenly max-[375px]:mt-0 mt-10 px-[clamp(20px,5vw,100px)] max-w-[1440px]">
      ...
      <div className="grid grid-cols-2 justify-center max-md:grid-cols-1 max-md:self-center  ">
        ...
        <div className="max-[375px]:order-1 absolute bottom-12 left-0 w-full max-md:static ml-[clamp(20px,5vw,100px)] max-md:ml-0">
          <CrewNav setId={setId} />
        </div>
        <section className="max-w-md max-lg:max-w-sm max-md:px-10 max-md:mt-10 max-[375px]:border-b max-[375px]:border-white max-[375px]:border-opacity-10 max-[375px]:mb-6 max-md:static absolute bottom-0 right-20 max-lg:right-0 ">
          <Image
